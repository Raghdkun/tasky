...
int _noteModelEstimateSize(
  ...
  {
    final value = object.notecontent;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _noteModelSerialize(
  ...
  writer.writeString(offsets[3], object.notecontent);
...
NoteModel _noteModelDeserialize(
  ...
  object.notecontent = reader.readStringOrNull(offsets[3]);
...
extension NoteModelQueryFilter
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorEqualTo(
    String? value, {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'color',
        value: '',
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> colorIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'color',
        value: '',
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> isfavEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isfav',
...
extension NoteModelQuerySortBy on QueryBuilder<NoteModel, NoteModel, QSortBy> {
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByColorDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByIsfav() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isfav', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByIsfavDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQuerySortThenBy
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'color', Sort.asc);
    });
  }
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByIsfav() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isfav', Sort.asc);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByIsfavDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isfav', Sort.desc);
    });
  }
...
extension NoteModelQueryWhereDistinct
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByColor(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByIsfav() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryProperty
  ...
  QueryBuilder<NoteModel, String?, QQueryOperations> colorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, bool, QQueryOperations> isfavProperty() {
    return QueryBuilder.apply(this, (query) {
